...
complete -c smartctl -s a -l all -d 'Prints all SMART information about the disk, or TapeAlert information about t…'
...
complete -c smartctl -s H -l health -d 'Prints the health status of the device or pending TapeAlert messages'
