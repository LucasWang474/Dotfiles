...
complete -c hdparm -l offset -d 'Offsets to given number of GiB (1024*1024*1024) when performing   -t timings …'
...
complete -c hdparm -s Z -d 'Disable the automatic power-saving function of certain Seagate drives (ST3xxx…'
