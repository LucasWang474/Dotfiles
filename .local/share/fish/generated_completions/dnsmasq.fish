...
complete -c dnsmasq -s B -l bogus-nxdomain -d 'Transform replies which contain the IP specified address or subnet into "No s…'
complete -c dnsmasq -l ignore-address -d 'Ignore replies to A-record queries which include the specified address or sub…'
