...
complete -c efibootmgr -s e -l edd30 -s 1 -d 'Force EDD 1. 0 or 3. 0 creation variables, or guess'
complete -c efibootmgr -s E -l edd-device -d 'EDD 1. 0 device number (defaults to 0x80)'
...
complete -c efibootmgr -s l -l loader -d 'Specify a loader (defaults to \\\\\\lilo. efi)'
...
complete -c efibootmgr -s q -l quiet -d 'Quiet mode - supresses output'
