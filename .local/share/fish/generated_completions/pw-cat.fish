...
complete -c pw-cat -l target -d 'Set a node target (default auto)'
complete -c pw-cat -l latency -d 'Set the node latency (default 100ms)  The latency determines the minimum amou…'
