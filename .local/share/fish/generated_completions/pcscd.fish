...
complete -c pcscd -s c -l config -d 'Specifies the file file as an alternate location for R /etc/reader. conf'
...
complete -c pcscd -s H -l hotplug -d 'Ask pcscd to re-read the  /etc/reader. conf. d/reader'
